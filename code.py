...
JSON_POST_URL = "https://api.thingspeak.com/update?api_key=8MPW4DVTLBMV16NZ&field1=0"
...
while True:
    ...
    if volts < 4:
        ...
        led.value = False
    volts= str(volts)
    print("POSTing data to {0}: {1}".format(JSON_POST_URL, volts))
    response = requests.post(JSON_POST_URL, data=volts)
    print('-'*40)
